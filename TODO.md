...
- [?] Service assignment with a config file (auto-gen or manual) #project/Homelab-manager 
- [?] Custom service config reload command(s): `"whenConfigUpdated": ["cmd1","cmd2"] ` #project/Homelab-manager 
